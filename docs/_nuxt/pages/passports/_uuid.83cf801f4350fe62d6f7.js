webpackJsonp([0], {
                    ...
                    c()(t, [
                        {
                            ...
                            value: function(t) {
                                ...
                                this.passports.push(e), this.savePassports();
                            }
                        },
                        {
                            key: "getPassport",
                            value: function(t) {
                                ...
                                try {
                                    for (
                                        var o, i = a()(this.passports);
                                        !(e = (o = i.next()).done);
                                        e = !0
                                    ) {
                                        var u = o.value;
                                        if (u.uuid === t) return u;
                                    }
                                } catch (t) {
                                    (r = !0), (n = t);
                                } finally {
                        ...
                        },
                        {
                            key: "removePassport",
                            value: function(t) {
                                for (var e = 0; e < this.passports.length; e++)
                                    if (this.passports[e].uuid === t.uuid) {
                                        this.passports.splice(e, 1);
                                        break;
                                    }
                                this.savePassports();
                            }
                        ...
                        },
                        {
                            key: "loadPassports",
                            value: function() {
                                var t = localStorage.getItem("passports");
                                if (t) {
                                    this.passports = JSON.parse(t);
                                    var e = !0,
                                        r = !1,
                                        n = void 0;
                                    try {
    ...
    "9ff9": function(t, e, r) {
        ...
        (e.render = function(t, e, r) {
            ...
            var a,
                u,
                s = n.getImageWidth(t.modules.size, o),
                f = i.getContext("2d"),
                c = f.createImageData(s, s);
            return (
        ...
        e.a = {
            ...
            methods: {
                createQRCode: function() {
                    var t = this.$route.params.uuid,
                        e = n.a.getPassport(t),
                        r = this.$refs.canvas,
                        o = e.uuid + "_" + (e.hasJewishAncestry ? 1 : 0);
                    i.a.toCanvas(r, o, { scale: 10 }, function(t) {
                        t && console.error(t);
                    });
                }
            },
            mounted: function() {
                n.a.loadPassports(), this.createQRCode();
            }
        };
    },
    RO0P: function(t, e, r) {
    ...
    WEzc: function(t, e, r) {
        ...
        function m(t, e, r) {
            ...
            var u =
                8 *
                (o.getSymbolTotalCodewords(t) - l.getTotalCodewordsCount(t, e));
            for (
            ...
            return (function(t, e, r) {
                ...
                for (P = 0; P < E; P++)
                    for (b = 0; b < s; b++)
                        P < y[b].length && (T[C++] = y[b][P]);
                for (P = 0; P < p; P++)
                    for (b = 0; b < s; b++) T[C++] = m[b][P];
                return T;
            })(i, t, e);
        }
        function E(t, e, r, n) {
            ...
            var h = g.getBestVersionForData(i, r);
            if (!h)
                throw new Error(
            ...
            return (
                ...
                n || (n = c.getBestMask(E, y.bind(null, E, r))),
                c.applyMask(n, E),
                y(E, r, n),
                {
                    modules: E,
    ...
    Zn9r: function(t, e, r) {
        ...
        var n = function() {
            var t = this.$createElement,
                e = this._self._c || t;
            return e("div", [e("canvas", { ref: "canvas" })]);
        };
        n._withStripped = !0;
        ...
        var n = {
            single_source_shortest_paths: function(t, e, r) {
                ...
                for (g.push(e, 0); !g.empty(); ) {
                    (u = (a = g.pop()).value), (f = a.cost), (c = t[u] || {});
                    for (s in c)
                        c.hasOwnProperty(s) &&
                            ((l = f + c[s]),
                            (h = i[s]),
                            (void 0 === i[s] || h > l) &&
                                ((i[s] = l), g.push(s, l), (o[s] = u)));
                }
    ...
    kJLo: function(t, e, r) {
        ...
        var n = r("PI/t"),
            o = r("Zn9r"),
            i = r("VU/8")(n.a, o.a, !1, null, null, null);
        (i.options.__file = "pages/passports/_uuid.vue"),
            (e.default = i.exports);
    },
    ljsv: function(t, e) {
        e.Patterns = {
    ...
    mwnW: function(t, e, r) {
        ...
        t.exports = function() {
            return (
                ...
                "function" == typeof n.Promise.prototype.then
            );
        };
    },
    nwDn: function(t, e) {
    ...
    nyx9: function(t, e, r) {
        ...
        function g(t) {
            var e,
                r,
                o = h(s.NUMERIC, n.NUMERIC, t),
                i = h(s.ALPHANUMERIC, n.ALPHANUMERIC, t);
            return (
                f.isKanjiModeEnabled()
                    ? ((e = h(s.BYTE, n.BYTE, t)), (r = h(s.KANJI, n.KANJI, t)))
                    : ((e = h(s.BYTE_KANJI, n.BYTE, t)), (r = [])),
                o
                    .concat(i, e, r)
                    .sort(function(t, e) {
                            ...
                            for (
                                ...
                                for (
                                    ...
                                    for (var h = 0; h < i.length; h++) {
                                        var g = i[h];
                                        r[g] && r[g].node.mode === c.mode
                                            ? ((o[g][l] =
                                                  d(
                                                      r[g].lastCount + c.length,
                                                      c.mode
                                                  ) -
                                                  d(r[g].lastCount, c.mode)),
                                              (r[g].lastCount += c.length))
                                            : (r[g] &&
                                                  (r[g].lastCount = c.length),
                                              (o[g][l] =
