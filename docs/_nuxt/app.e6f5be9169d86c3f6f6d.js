    ...
    [6],
    {
        ...
        F88d: function(t, o, e) {
            ...
            var a = function(t) {
                ...
                l = e("VU/8")(r.a, n.a, !1, a, null, null);
            (l.options.__file = ".nuxt/components/nuxt-loading.vue"),
                (o.a = l.exports);
        },
        "HBB+": function(t, o, e) {
            "use strict";
            o.a = {
                ...
                render: function(t, o) {
                    ...
                    for (
                        var a = e,
                            l = e.$nuxt.nuxt.transitions,
                            d = e.$nuxt.nuxt.defaultTransition,
                            p = 0;
                        e;

                    )
                        e.$vnode && e.$vnode.data.nuxtChild && p++,
                            (e = e.$parent);
                    i.nuxtChildDepth = p;
                    var m = l[p] || d,
                        s = {};
                    ...
                    return (
                        n.forEach(function(t) {
                            "function" == typeof m[t] && (c[t] = m[t].bind(a));
                        }),
                        t("transition", { props: s, on: c }, [
                            t("router-view", i)
                        ])
                    );
                }
        ...
        "Hot+": function(t, o, e) {
            ...
            o.a = {
                ...
                props: ["nuxtChildKey"],
                render: function(t) {
                    return this.nuxt._redirected
                        ? t("div", ["Redirecting to external page."])
                        : this.nuxt.err
                          ? t("nuxt-error", { props: { error: this.nuxt.err } })
                          : t("nuxt-child", { key: this.routerViewKey });
                },
                ...
                computed: {
                    routerViewKey: function() {
                        if (
                            ...
                            return (
                                this.nuxtChildKey ||
                                Object(a.b)(this.$route.matched[0].path)(
                                    this.$route.params
                                )
                            );
                        var t =
                ...
                components: { NuxtChild: n.a, NuxtError: i.a }
            };
        },
        Iqfs: function(t, o, e) {
            var r = e("N1rB");
        ...
        "P+aQ": function(t, o, e) {
            ...
            r._withStripped = !0;
            var n = { render: r, staticRenderFns: [] };
            o.a = n;
        },
        QhKw: function(t, o, e) {
            "use strict";
            var r = function() {
                var t = this.$createElement,
                    o = this._self._c || t;
                return o("div", { staticClass: "__nuxt-error-page" }, [
                    o("div", { staticClass: "error" }, [
                        o(
                            "svg",
                            {
                                attrs: {
        ...
        T23V: function(t, o, e) {
                                    ...
                                    switch ((t.prev = t.next)) {
                                        ...
                                        case 6:
                                            if (
                                                ((this._dateLastError =
                                                    $.nuxt.dateErr),
                                                (this._hadError = !!$.nuxt.err),
                                                (a = Object(z.e)(o)).length)
                                            ) {
                                                t.next = 23;
                                                break;
                                            }
                                    ...
                                    switch ((t.prev = t.next)) {
                                        ...
                                        case 9:
                                            if (
                                                ...
                                                (r.$loading = {}),
                                                M.error && r.error(M.error),
                                                R.beforeEach(j.bind(r)),
                                                R.beforeEach(_.bind(r)),
                                                R.afterEach(A),
                                                R.afterEach(B.bind(r)),
                                                !M.serverRendered)
                                            ) {
                                                t.next = 22;
                                                break;
            ...
            function T(t, o, e) {
                var r = function(t) {
                    var r =
                        (function(t, o) {
                            if (!t || !t.options || !t.options[o]) return {};
                            var e = t.options[o];
                ...
                return t.map(function(t) {
                    ...
                    if (
                        ...
                        var n = r(e.matched[0].components.default);
                        x()(n)
                            .filter(function(t) {
                                return (
                                    n[t] &&
                                    -1 !== t.toLowerCase().indexOf("leave")
                                );
                            })
                            .forEach(function(t) {
                                o[t] = n[t];
            ...
            function O(t) {
                var o,
                    e = this,
                    r = Object(z.d)(t.options.base, t.options.mode);
                return Object(z.c)(
                    t.match(r),
                    ((o = g()(
                        s.a.mark(function t(o, r, n, i, a) {
                            var l;
                            return s.a.wrap(
                                function(t) {
                                    for (;;)
            ...
            function q(t, o, e) {
                ...
                if (
                    (void 0 !== e &&
                        ((n = []),
                        e.middleware && (n = n.concat(e.middleware)),
                    ...
                    return Object(z.i)(n, o);
            }
            function A(t, o) {
                Object(z.c)(t, function(t, o, e, r) {
                    return (
            ...
            function L(t) {
                ...
                "function" == typeof o && (o = o($.context)), this.setLayout(o);
            }
            function B(t, o) {
                var e = this;
                (!1 === this._pathChanged && !1 === this._queryChanged) ||
                    v.default.nextTick(function() {
                        Object(z.f)(t).forEach(function(o, e) {
                            if (
                                o &&
                                -1 !== t.matched[e].path.indexOf(":") &&
                                o.constructor._dataRefresh &&
                                E[e] === o.constructor._path &&
                                "function" == typeof o.constructor.options.data
                            ) {
                                var r = o.constructor.options.data.call(o);
                                for (var n in r)
                                    v.default.set(o.$data, n, r[n]);
                            }
                        }),
                            L.call(e, t);
                    });
            ...
            function S(t) {
                window._nuxtReadyCbs.forEach(function(o) {
                    "function" == typeof o && o(t);
                }),
                    "function" == typeof window._onNuxtLoaded &&
                        window._onNuxtLoaded(t),
                    R.afterEach(function(o, e) {
                        v.default.nextTick(function() {
                            return t.$nuxt.$emit("routeChanged", o, e);
                        });
                    });
            }
            Object(y.b)()
        ...
        WRRc: function(t, o, e) {
            ...
            o.a = {
                ...
                functional: !0,
                render: function(t, o) {
                    return t("router-link", o.data, o.children);
                }
            };
        },
        YLfZ: function(t, o, e) {
            "use strict";
            (o.a = function(t, o) {
                var e = t.options.data || h;
                if (!o && t.options.hasAsyncData) return;
                (t.options.hasAsyncData = !0),
                    (t.options.data = function() {
                        var r = e.call(this);
                        return (
                            this.$ssrContext &&
                                (o = this.$ssrContext.asyncData[t.cid]),
                            u()({}, r, o)
                        );
                    }),
                    t._Ctor &&
                ...
                (o.f = function(t) {
                    return [].concat.apply(
                        ...
                        t.matched.map(function(t) {
                            return f()(t.instances).map(function(o) {
                ...
                (o.i = function t(o, e) {
                    if (!o.length || e._redirected || e._errored)
                        return c.a.resolve();
                    return E(o[0], e).then(function() {
                        return t(o.slice(1), e);
                    });
                }),
                (o.j = E),
                (o.d = function(t, o) {
                        ...
                        return function(e, r) {
                            for (
                                var i = "",
                                    a = e || {},
                                    l = r || {},
                                    d = l.pretty ? R : encodeURIComponent,
                                    p = 0;
                                p < t.length;
                                p++
                            ) {
            ...
            function v(t) {
                return [].concat.apply(
                    [],
                    t.matched.map(function(t) {
                        return f()(t.components).map(function(o) {
            ...
            function k(t, o) {
                return Array.prototype.concat.apply(
                    ...
                    t.matched.map(function(t, e) {
                        return f()(t.components).map(function(r) {
                            return o(t.components[r], t.instances[r], t, r, e);
                        });
                    })
                );
            }
                            ...
                            function(t) {
                                for (;;)
                                    switch ((t.prev = t.next)) {
                                        ...
                                        case 13:
                                            if (
                                                ((o.context.next = e.next),
                                                (o.context._redirected = !1),
                                                (o.context._errored = !1),
                                                (o.context.isHMR = !!e.isHMR),
                                                !e.route)
                                            ) {
                                                t.next = 21;
                                                break;
                                            }
                                            return (t.next = 20), _(e.route);
                                        case 20:
                                            o.context.route = t.sent;
                                        case 21:
                                            if (
                                                ((o.context.params =
                                                    o.context.route.params ||
                                                    {}),
                                                (o.context.query =
                                                    o.context.route.query ||
                                                    {}),
                                                !e.from)
                                            ) {
                                                t.next = 27;
                                            ...
                                            return (t.next = 26), _(e.from);
                                        case 26:
                                            o.context.from = t.sent;
                                        case 27:
                                        case "end":
                                            return t.stop();
                                    }
                ...
                return (
                    ((e =
                        2 === t.length
                            ...
                            : t(o)) &&
                        (e instanceof c.a || "function" == typeof e.then)) ||
                        (e = c.a.resolve(e)),
                    e
                );
            }
            ...
            function M(t, o) {
                var e = void 0,
                    r = t.indexOf("://");
                -1 !== r
                    ? ((e = t.substring(0, r)), (t = t.substring(r + 3)))
                ...
                var i,
                    ...
                    p = void 0;
                return (
                    2 === (a = d.split("#")).length && ((d = a[0]), (p = a[1])),
                    (l += d ? "/" + d : ""),
                    o &&
                        "{}" !== n()(o) &&
                        (l +=
        ...
        ct3O: function(t, o, e) {
            ...
            var a = function(t) {
                ...
                l = e("VU/8")(r.a, n.a, !1, a, null, null);
            (l.options.__file = ".nuxt/components/nuxt-error.vue"),
                (o.a = l.exports);
        },
        dhps: function(t, o, e) {
            "use strict";
            ...
            o.a = {
                ...
                methods: {
                    ...
                    increase: function(t) {
                        return (
                            (this.percent = this.percent + Math.floor(t)), this
                        );
                    },
                    decrease: function(t) {
                        return (
        ...
        mtxM: function(t, o, e) {
            ...
            o.a = function() {
                return new n.default({
                    ...
                    scrollBehavior: p,
                    routes: [
                        { path: "/", component: i, name: "index" },
                        { path: "/passports", component: a, name: "passports" },
                        { path: "/dilemmas", component: l, name: "dilemmas" },
                        {
                            path: "/passports/:uuid",
                            component: d,
                            name: "passports-uuid"
                    ...
                    return (
                        t.matched.length < 2
                            ...
                            : t.matched.some(function(t) {
                                  return t
                                      .components.default.options.scrollToTop;
                              }) && (r = { x: 0, y: 0 }),
        ...
        qcny: function(t, o, e) {
                                    ...
                                    switch ((t.prev = t.next)) {
                                        ...
                                        case 7:
                                            (function(t, o) {
                                                ...
                                                g.default[e] ||
                                                    ((g.default[e] = !0),
                                                    g.default.use(function() {
                                                        g.default.prototype.hasOwnProperty(
                                                            t
                                                        ) ||
                                                            l()(
                                                                g.default
            ...
            g.default.component(w.a.name, w.a),
                g.default.component(v.a.name, v.a),
                g.default.component(k.a.name, k.a),
                g.default.component(z.a.name, z.a),
                g.default.use(x.a, {
                    keyName: "head",
        ...
        yTq1: function(t, o, e) {
            ...
            o.a = {
                head: {
                    ...
                    script: [{ src: "/instascan.min.js", async: !0 }],
                    link: [],
                    style: []
                },
                render: function(t, o) {
                    var e = t("nuxt-loading", { ref: "loading" }),
                ...
                methods: {
                    ...
                    setLayout: function(t) {
                        (t && p["_" + t]) || (t = "default"),
                            (this.layoutName = t);
                        var o = "_" + t;
                        return (this.layout = p[o]), this.layout;
                    },
                    loadLayout: function(t) {
                        var o = this;
                        (t && (d["_" + t] || p["_" + t])) || (t = "default");
                        var e = "_" + t;
                        return p[e]
                            ? n.a.resolve(p[e])
                            : d[e]()
                                  .then(function(t) {
                                      return (p[e] = t), delete d[e], p[e];
                                  })
                                  .catch(function(t) {
                                      if (o.$nuxt)
                                          return o.$nuxt.error({
